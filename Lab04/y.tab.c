...
#line 1214 "syntax_analyzer.y"
    {
		...
		AssignNode* assignNode = new AssignNode((VarNode*)varNode->clone(), addNode, (yyvsp[(1) - (2)])->getvartype());
		(yyval)->set_ast_node(assignNode);
	}
    break;
...
#line 1230 "syntax_analyzer.y"
    {
		...
		AssignNode* assignNode = new AssignNode((VarNode*)varNode->clone(), subNode, (yyvsp[(1) - (2)])->getvartype());
		(yyval)->set_ast_node(assignNode);
	}
    break;
