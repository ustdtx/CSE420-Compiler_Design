...
factor	: variable  // factor can be void
	...
	| variable INCOP 
	{
		...
		AssignNode* assignNode = new AssignNode((VarNode*)varNode->clone(), addNode, $1->getvartype());
		$$->set_ast_node(assignNode);
	}
	| variable DECOP
	{
		...
		AssignNode* assignNode = new AssignNode((VarNode*)varNode->clone(), subNode, $1->getvartype());
		$$->set_ast_node(assignNode);
	}
	;
